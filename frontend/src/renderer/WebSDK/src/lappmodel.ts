...
export class LAppModel extends CubismUserModel {
  ...
  public update(): void {
    ...
    if (this._lipsync) {
      let value = 0.0;
      if (this._realtimeLipSyncRms !== null) {
        value = this._realtimeLipSyncRms;
      } else {
  ...
  _realtimeLipSyncRms: number | null = null;

  public setRealtimeLipSyncRms(value: number | null): void {
    this._realtimeLipSyncRms = value;
  }

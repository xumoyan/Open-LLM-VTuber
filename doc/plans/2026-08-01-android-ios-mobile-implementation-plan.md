...
当前测试标识：App 名称 `AI 外教`、iOS bundle ID/Android application ID `ai.english.tutor`、Android Debug 测试后端 `http://221.216.142.88:18081`。
...
4. Android Debug 测试后端：`221.216.142.88:18081`。
